...
const contactMethods = [
  ...
  {
    label: "Email",
    value: "info@ajeventspromotions.com",
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
              ...
              <div className="mt-12 space-y-4">
                {contactMethods.map((m) => (
                  <a
                    ...
                    className="group flex items-center gap-4 border-b border-white/10 pb-4 transition hover:border-white/25"
                  >
                    ...
                    <span>
                      <span className="block text-[10px] font-bold uppercase tracking-[0.25em] text-white/40">
                        {m.label}
                      </span>
                ...
                <div className="flex gap-4">
                  {socials.map((s) => (
                    <a
                      ...
                      className="text-[11px] font-semibold uppercase tracking-[0.25em] text-white/45 transition hover:text-white"
                    >
                      {s.name}
                    </a>
                  ))}
            ...
            <div>
              <div className="border border-white/10 p-6 md:p-10">
                <p className="mb-8 text-[11px] font-bold uppercase tracking-[0.25em] text-white/40">
                  Send an enquiry
                </p>
                <TestContactForm />
              </div>
      ...
      <section className="border-t border-white/10 px-6 py-16 md:px-12 lg:px-20">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-white/45">
            Send your venue, date, timings, and vibe. We&apos;ll respond within
            24 hours with availability and a transparent quote — no hidden fees.
          </p>
        </div>
      </section>
    </main>
