        ...
        <div className="mx-auto max-w-4xl">
          ...
          <header className="mb-16 md:mb-20">
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-white/55 md:text-lg">
              Everything you need to know about booking DJ Ludzy for your
              event. Can&apos;t find what you&apos;re looking for?{" "}
              <Link
                href="/test/contact"
          ...
          <div className="mt-16 border-t border-white/10 pt-12 text-center md:mt-20">
            <h2 className="font-display text-2xl font-bold uppercase tracking-[-0.01em] text-white md:text-3xl">
