...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${event.title} | DJ Ludzy Events`,
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <nav aria-label="Breadcrumb" className="mb-12">
            <ol className="flex items-center gap-2 text-[11px] uppercase tracking-[0.3em] text-white/35">
              ...
              <li aria-hidden>/</li>
              <li>
                <Link href="/test/events" className="transition hover:text-white/60">
                  Events
                </Link>
              </li>
              <li aria-hidden>/</li>
          ...
          <header className="mb-12 border-b border-white/10 pb-10 md:mb-16 md:pb-14">
            ...
            <h1 className="mt-4 font-display text-3xl font-bold uppercase leading-[0.95] tracking-[-0.01em] text-white md:text-4xl lg:text-5xl">
              {event.title}
            </h1>
