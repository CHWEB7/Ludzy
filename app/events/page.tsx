      ...
      <div className="relative mx-auto min-w-0 max-w-7xl px-5 pb-28 pt-10 md:px-10 md:pt-14">
        <header className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-sm leading-relaxed text-white/65 md:text-base">
            ...
            slots expand in place with time, location, and set style. All copy below is
            template text you can edit later.
          </p>
          <Link
            href="/"
        ...
        <div className="mt-16 space-y-20 md:mt-24 md:space-y-28">
          ...
          <SwipeCarousel
            ...
            description="Confirmed and provisional dates — tap to expand. No separate page; details open on the card."
          >
